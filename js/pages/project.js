...
export function openDrawer(id) {
    ...
    if (id === 'new_project') {
        ...
        dBody.innerHTML = `
            <div class="drawer-section">
                <div class="form-group" style="margin-bottom: 20px;">
                    <label class="form-label">Target Budget Line</label>
                    <select class="form-input">
                        <option>01-LAB Site Labor</option>
                        <option>02-MAT Construction Materials</option>
                        <option>03-EQU Equipment Rental</option>
                    </select>
                </div>
