...
const MACHINE_TYPES = {
  Dozer:       { label: 'Crawler Bulldozer',        icon: 'fa-tractor',           defaultDailyRate: 1150000 },
  Excavator:   { label: 'Hydraulic Excavator',      icon: 'fa-truck-monster',     defaultDailyRate: 900000 },
  Loader:      { label: 'Wheel Loader',             icon: 'fa-truck-loading',     defaultDailyRate: 775000 },
  Truck:       { label: 'Dump Truck',               icon: 'fa-truck',             defaultDailyRate: 475000 },
  Grader:      { label: 'Motor Grader',             icon: 'fa-road',              defaultDailyRate: 1000000 },
  Roller:      { label: 'Vibratory Roller',         icon: 'fa-drum',              defaultDailyRate: 650000 },
  Bowser:      { label: 'Water Bowser',             icon: 'fa-droplet',           defaultDailyRate: 350000 },
  Mixer:       { label: 'Concrete Mixer Truck',     icon: 'fa-blender',           defaultDailyRate: 675000 },
  Sprayer:     { label: 'Bitumen Pressure Sprayer',  icon: 'fa-spray-can',         defaultDailyRate: 800000 },
  ChipSpreader:{ label: 'Chip Spreader',            icon: 'fa-align-justify',     defaultDailyRate: 550000 },
  PneuRoller:  { label: 'Pneumatic Tyre Roller',    icon: 'fa-circle',            defaultDailyRate: 700000 },
  ...
  Pickup:      { label: 'Crew Pickup/Light Truck',  icon: 'fa-car-side',          defaultDailyRate: 140000 },
  Generator:   { label: 'Diesel Generator (150kVA)', icon: 'fa-bolt',              defaultDailyRate: 185000 },
  LineMarker:  { label: 'Road Marking Machine',     icon: 'fa-pen',               defaultDailyRate: 200000 },
  Vibrator:    { label: 'Concrete Vibrator',        icon: 'fa-wave-square',       defaultDailyRate: 25000 },
  BatchPlant:  { label: 'Concrete Batching Plant',  icon: 'fa-industry',          defaultDailyRate: 850000 },
  TransitMixer:{ label: 'Transit Concrete Mixer',   icon: 'fa-truck-moving',      defaultDailyRate: 675000 },
  SlipPaver:   { label: 'Concrete Slip-form Paver', icon: 'fa-layer-group',       defaultDailyRate: 1600000 },
  TextureMachine:{ label: 'Surface Texturing Machine', icon: 'fa-brush',          defaultDailyRate: 280000 },
  SawCutter:   { label: 'Concrete Joint Saw',       icon: 'fa-compact-disc',      defaultDailyRate: 60000 },
